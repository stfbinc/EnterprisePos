...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="well">
                <legend>Transaction Log For Current Shift</legend>
                <div class="row">
                    <div class="col-md-4"> 
                ...
                <table class="table table-bordered table-striped" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder_DGTransaction" style="width:100%;border-collapse:collapse;">
                    <tbody>
                        <tr class="grid-header">
                            <th scope="col">Order Number</th><th scope="col">TransactionDate/Time</th><th scope="col">Amount</th>
                        </tr>
                        <?php foreach($transactions as $key => $transaction_data) {
